...
6.Lisää edellisiin luokkiin seuraava toiminnallisuus polymorfismia hyödyntäen:
Määrittele eläin-luokka abstraktiksi ja lisää siihen abstrakti puhu-metodi. 
7.Toteuta tämän jälkeen kissalle, papukaijalle ja lampaalle omat toteutuksensa 
puhu-metodille. 
.*/

import java.util.*;
//toteutettava luokka
public class miniprojekti7b {
//eläinluokka
...
////////////////////////////////////////////////////////////////////
/*8.Lisää lopuksi pääohjelmaan osio, jossa lisäät kissan, 
papukaijan ja lampaan samaan eläin-taulukkoon ja käyt taulukon alkiot läpi 
kutsuen jokaisen kohdalla puhu-metodia. Tällöin jokaisen eläimen tulisi puhua 
...
//pääohjelma
	public static void main(String[] args)
	{
		...
		Scanner lukija;
		lukija = new Scanner(System.in);
		//luodaan kissa, papukaija ja lammas
		...
		//laitetaan taulukkoon
		elaimet[0] = kissa;
		elaimet[1] = papukaija;
		elaimet[2] = lammas;
		//kutsutaan jokaisen puhu metodia
		for(int i = 0; i < 3; i++)
		{
			elaimet[i].Puhu();
		}
